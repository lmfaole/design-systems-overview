...
import actionConfirmation from "@/data/mønster/posts/action-confirmation";
import emptyStates from "@/data/mønster/posts/empty-states";
import progressWhenWaiting from "@/data/mønster/posts/progress-when-waiting";
import skeletonWhenStructureIsKnown from "@/data/mønster/posts/skeleton-when-structure-is-known";
import statusInUpdatedRegion from "@/data/mønster/posts/status-in-updated-region";

export function getPatternSlug(post: Pick<PatternPost, "title"> & { slug?: string }): string {
...
export const patternPosts: PatternPost[] = createPatternPosts([
    statusInUpdatedRegion,
    skeletonWhenStructureIsKnown,
    progressWhenWaiting,
    emptyStates,
    actionConfirmation,
]);
...
export function getPatternHref(post: Pick<PatternPost, "title" | "slug">): string {
