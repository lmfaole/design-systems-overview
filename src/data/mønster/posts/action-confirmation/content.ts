...
export const actionConfirmationContent: PatternPostContent = {
    ...
    furtherReading: [
        ...
        },
        {
            ...
            description: "Viser når en statusmelding er riktig semantikk for bekreftelser som oppdateres etter en handling.",
        },
        {
        ...
        },
        {
            ...
            description: "Nyttig når en bekreftelse skal vises først etter at lagring eller innsending faktisk er ferdig.",
        },
    ],
};
