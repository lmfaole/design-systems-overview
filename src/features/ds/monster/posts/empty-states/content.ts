    ...
    furtherReading: [
        {
            ...
            description: "Bruk Card når tomtilstanden skal vises som en avgrenset flate i innholdet.",
        },
        {
            title: "Jøkul Button",
            href: "/ds/jokul/component/button",
            description: "Primærknappen skal gi brukeren et tydelig første steg ut av tomtilstanden.",
        },
        {
            title: "Jøkul Message",
            href: "/ds/jokul/component/message",
            description: "Passer når tomtilstanden skyldes et filter, søk eller en annen midlertidig avgrensning.",
        },
        {
