...
const doc: ComponentDoc = {
    ...
    relationships: {
        subcomponents: [
            {
                id: "file",
                description: "Bruk File når du trenger å vise eller gjenbruke presentasjonen av en opplastet fil uten hele FileInput-opplevelsen."
            },
        ],
        related: [
            {
                id: "text-input",
                description: "Bruk TextInput for enkeltlinjers tekst; FileInput håndterer filopplasting med dra-og-slipp og opplastingsstatus."
            },
        ],
    },
