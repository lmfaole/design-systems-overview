...
export const props: PropDef[] = [
        ...
        },
        {
            ...
            source: "custom",
            status: "stable",
            description: "Polymorf — bytt ut rotelementet. Bruk as=\"div\" med background-image for CSS-baserte bilder, eller en egen bildekomponent hvis rammeverket ditt krever det.",
        },
        {
            name: "src",
            type: "string",
