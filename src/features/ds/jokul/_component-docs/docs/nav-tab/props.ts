...
export const props: PropDef[] = [
    { name: "as", type: "React.ElementType", required: false, default: '"a"', source: "custom", status: "stable", description: "Elementtype å rendre som. Bruk f.eks. en router-lenke hvis du vil integrere med klientnavigasjon." },
