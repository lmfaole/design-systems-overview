import {TypographyIllustration} from "@/features/ds/jokul/_shared/components/Illustration";
import {
    ...
    tokenOverview: [
        ...
        },
        {
          ...
          <code>{formatPublicTypographyTokenPath(path)}</code>
                    {aliasPath && (
                        <>
                            <br/>
                            <code>{formatPublicTypographyTokenPath(aliasPath)}</code>
                        </>
                    )}
        </span>,
                value,
        ...
        },
        {
          ...
          <code>{formatPublicTypographyTokenPath(path)}</code>
                ...
                <span key={`${path}-small`}>
          <code>{small.fontSize}</code>
          <br/>
          <code>{small.lineHeight}</code>
          <br/>
          <code>{small.fontWeight}</code>
        </span>,
                <span key={`${path}-base`}>
          <code>{base.fontSize}</code>
          <br/>
          <code>{base.lineHeight}</code>
          <br/>
          <code>{base.fontWeight}</code>
        </span>,
                usage,
            ]),
        },
